...
public class SingleStoneRedAllianceSide extends LinearOpMode {
    ...
    public SingleStoneRedAllianceSide.AutonomousStates DriveToFirstBlock() {
        ...
        return SingleStoneRedAllianceSide.AutonomousStates.DRIVEN_TO_FIRST_BLOCK;
    }

    public SingleStoneRedAllianceSide.AutonomousStates DriveToSecondBlock() {
        switch (_location) {
            case left:
        ...
        _flap.setPosition(0);
        sleep(500); // need time for flap to open
        return SingleStoneRedAllianceSide.AutonomousStates.DRIVEN_TO_SECOND_BLOCK;
    }

    public SingleStoneRedAllianceSide.AutonomousStates PickUpFirstBlock() {
        PickUpBlock2();

        return SingleStoneRedAllianceSide.AutonomousStates.PICKED_UP_FIRST_BLOCK;
    }

    public SingleStoneRedAllianceSide.AutonomousStates PickUpSecondBlock() {
        PickUpBlock2();

        return SingleStoneRedAllianceSide.AutonomousStates.PICKED_UP_SECOND_BLOCK;
    }
    ...
    public SingleStoneRedAllianceSide.AutonomousStates DriveToBridgeForFirstBlock() {
        switch (_location) {
            case left:
        ...
        return SingleStoneRedAllianceSide.AutonomousStates.DRIVEN_TO_BRIDGE_FOR_FIRST_BLOCK;
    }

    public SingleStoneRedAllianceSide.AutonomousStates DriveToBridgeForSecondBlock() {
        ...
        return SingleStoneRedAllianceSide.AutonomousStates.DRIVEN_TO_BRIDGE_FOR_SECOND_BLOCK;
    }

    public SingleStoneRedAllianceSide.AutonomousStates DriveUnderBridge() {
        _mecanum.MoveBackwardsRunWithEncoders(motorPower, 1150, this);
        return SingleStoneRedAllianceSide.AutonomousStates.DRIVEN_UNDER_BRIDGE;
    }
    ...
    public SingleStoneRedAllianceSide.AutonomousStates DropOffFirstBlock() {
        DropOffBlock();

        return SingleStoneRedAllianceSide.AutonomousStates.DROPPED_OFF_FIRST_BLOCK;
    }

    public SingleStoneRedAllianceSide.AutonomousStates DropOffSecondBlock() {
        DropOffBlock();

        return SingleStoneRedAllianceSide.AutonomousStates.DROPPED_OFF_SECOND_BLOCK;
    }

    public void runOpMode() {
        SingleStoneRedAllianceSide.AutonomousStates currentState = SingleStoneRedAllianceSide.AutonomousStates.STARTED;
        int counter = 0;
        ...
        while (opModeIsActive() && (currentState != SingleStoneRedAllianceSide.AutonomousStates.DRIVEN_UNDER_BRIDGE)) {
            switch (currentState) {
                case STARTED:
